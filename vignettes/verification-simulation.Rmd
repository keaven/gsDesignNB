...
$$ V_{\text{theo}} = \frac{1/\mu_1 + k_{\text{adj}}}{n_1} + \frac{1/\mu_2 + k_{\text{adj}}}{n_2} $$

where $\mu_i = \lambda_{i,\text{eff}} \bar{t}$ is the expected number of events per subject in group $i$ 
(using effective rates adjusted for event gaps), and $k_{\text{adj}} = k \cdot Q$ is the dispersion parameter inflated for variable follow-up.
