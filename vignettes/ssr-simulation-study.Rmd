...
For hypothesis testing, the main power simulations now use the
`mutze_test()` score statistic. This aligns the SSR power grid with the
score-test recommendation used elsewhere in the package documentation. The
dedicated non-binding Type I tables compare Wald and score testing under the
same one-sided $\alpha = 0.025$ group sequential design.
...
score statistic. The power simulations use the score statistic throughout.
