...
adequate and when the score-test, two-variance calculation is preferable.
...
- Use the Zhu--Lakkis / Friede--Schmidli / Mutze Wald formula when the planned primary analysis is
  the Wald log-rate-ratio test and simulation verifies the intended Type I error and power for the
  design scenario.
- Move to the score-test workflow when Type I error preservation is the primary concern, especially
  ...
  margins, or adaptive/group sequential settings. In that workflow, size with
  `sample_size_nbinom(test_type = "score")` and analyze or simulate with
  `mutze_test(test_type = "score")`, `sim_gs_nbinom(test_type = "score")`, or
  `sim_ssr_nbinom(test_type = "score")`.
- Score-test power is slightly conservative in this grid. If the score test is the planned primary
  analysis, verify power by simulation and consider a modest sample-size or target-power margin
