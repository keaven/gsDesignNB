...
The function approximates the impact using the result that for a Poisson process with rate $\lambda$ and gap $g$, the effective rate is:

$$ \lambda_{\text{eff}} = \frac{\lambda}{1 + \lambda g} $$

This adjusted rate is used in the expected count calculation: $\mu_g = \lambda_{g,\text{eff}} \cdot \bar{t}_g$.
