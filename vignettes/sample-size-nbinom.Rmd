...
It is most useful when finite-sample Type I error control is the dominant objective, for example in lower-information designs, high-dispersion settings, event-gap settings, non-inferiority or super-superiority hypotheses, or adaptive/group sequential designs that will use a score statistic at analysis.
If the planned analysis remains the Wald log-rate-ratio test, the Zhu--Lakkis Wald formula remains the directly matched calculation; either choice should be verified by simulation for the design scenario.
