...
```{r, fig.width=7, fig.height=5, fig.alt="Patient timelines with events (dots) and censoring (X)"}
...
Using the truncated data we can run a Negative Binomial Wald test as described by
Mütze et al. (2018).
...
`get_analysis_date()` and then cut the data accordingly.
