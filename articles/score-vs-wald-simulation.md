...
Figures are interactive when the optional `plotly` package is installed;
otherwise they render as static `ggplot2` figures.

Results are pre-computed by `data-raw/generate_score_sweep.R` and loaded
here.
